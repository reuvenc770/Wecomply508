...
wc.interface.navigation = {
	...
	enableButtonFromDelay: function (buttonId) {
		var buttonToEnable = document.getElementById(buttonId);
		if (!isDefined(buttonToEnable))
			return;
                if (wc.interface.navigation.insecondlayer) {

// if saved state is not enabled, means I am in a second layer and I should simply enable the saved state so it enables when I return
wc.interface.navigation.saveState.buttonsToEnable |= wc.interface.navigation.buttonTypes.NextChapter;

//alert("buttonsToDisable " + wc.interface.navigation.saveState.buttonsToDisable + " nextchapter " + wc.interface.navigation.buttonTypes.NextChapter + " not nextchapter " + ~wc.interface.navigation.buttonTypes.NextChapter);

wc.interface.navigation.saveState.buttonsToDisable = ~wc.interface.navigation.buttonTypes.NextChapter & wc.interface.navigation.saveState.buttonsToDisable;
//alert("buttonsToDisable " + wc.interface.navigation.saveState.buttonsToDisable + " nextchapter " + wc.interface.navigation.buttonTypes.NextChapter + " not nextchapter " + ~wc.interface.navigation.buttonTypes.NextChapter);


wc.interface.navigation.saveState.buttonsToEnable |= wc.interface.navigation.buttonTypes.PreviousChapter;

wc.interface.navigation.saveState.buttonsToDisable = ~wc.interface.navigation.buttonTypes.PreviousChapter & wc.interface.navigation.saveState.buttonsToDisable;

//			alert('in second layer');


                } else {
// if saved state is enabled, means I am in the normal layer and should enable button normally
wc.interface.navigation.enableButton(buttonId);
// alert('not in second layer');
		}
	...
	updateButtons: function (buttonsToEnable, buttonsToDisable, buttonsToHide, buttonsToActivate) {
...
//alert("in restoreButtonsToSavedState buttonsToEnable " + wc.interface.navigation.saveState.buttonsToEnable + " buttonsToDisable " + wc.interface.navigation.saveState.buttonsToDisable + " buttonsToHide " + wc.interface.navigation.saveState.buttonsToHide + " buttonsToActivate " + wc.interface.navigation.saveState.buttonsToActivate);
