...
// for edjones, enable next if we are below highest bookmark
if (nextChapterIndex + 1 < wc.lms.highestBookmark) {
  setTimeout("wc.interface.navigation.enableButtonFromDelay(\"Button_Next\");",50);
}
