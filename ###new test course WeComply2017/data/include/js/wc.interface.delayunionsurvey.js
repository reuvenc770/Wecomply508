...
// for pseg, no final quiz question, go directly to cert
...
alert("You have just completed COURSE 2. Thank you!  \n\nYour responses to the quiz are recorded in the system. Any updates to the responses going forward will not be recorded.  \n\nYour Certificate of Completion for COURSE 2 will appear on the next slide.  If you wish to print this certificate, please adjust your printer settings to landscape mode.");
