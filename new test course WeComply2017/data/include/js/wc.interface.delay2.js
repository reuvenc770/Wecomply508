...
//testing
console.log("parse pithyquote " + pithyQuote);
		if (window.DOMParser) {
			var parser = new DOMParser();
			myxmlDoc = parser.parseFromString(pithyQuote, "text/xml");
console.log ("dom parser");
		}
		else {
			myxmlDoc = new ActiveXObject("Microsoft.XMLDOM");
			myxmlDoc.async = false;
			myxmlDoc.loadXML(pithyQuote);
console.log("xmldom");
console.log("got xml " + myxmlDoc.xml);
		}
...
console.log("in parse error thrown " + "inner HTML " + bulletsNode.innerHTML + "caught error, text " + bulletsNode.text + " firstchild " + bulletsNode.firstChild.textContent + " firstchildinnertext " + bulletsNode.firstChild.innerText  + " nodevalue " + bulletsNode.firstChild.nodeValue + " firstchildtext " + bulletsNode.firstChild.text);
...
console.log("error thrown " + ex.message + "inner HTML " + childNode.innerHTML + " xml " + childNode.xml + " firstchild xml " + childNode.firstChild.xml + "caught error, text " + childNode.text + " firstchild " + childNode.firstChild.textContent + " firstchildinnertext " + childNode.firstChild.innerText  + " nodevalue " + childNode.firstChild.nodeValue + " firstchildtext " + childNode.firstChild.text);
							bullet.content = childNode.firstChild.xml || childNode.innerHTML || childNode.text || childNode.firstChild.textContent || childNode.firstChild.innerText || childNode.firstChild.nodeValue || childNode.firstChild.text;
