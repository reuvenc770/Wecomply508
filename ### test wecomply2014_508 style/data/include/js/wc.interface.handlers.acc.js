...
wc.interface.handlers.events.mediaPlayer = {
	onAudioComplete: function () {
		if (isDefined(wc.data.jsonData.waitForAudio) && wc.data.jsonData.waitForAudio == '1') {
			...
			var buttonsToHighlight = wc.interface.navigation.buttonTypes.NextChapter;
			wc.interface.navigation.updateButtons(buttonsToEnable, buttonsToDisable, buttonsToHide, buttonsToHighlight);
		}
